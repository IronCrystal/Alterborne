...
[CustomEditor(typeof(Destroy_By_Colliding_By_Parent))]
public class Destroy_By_Colliding_By_Parent_Editor : Editor {

	public override void OnInspectorGUI(){
		// Grab the script.
		Destroy_By_Colliding_By_Parent myTarget = target as Destroy_By_Colliding_By_Parent;
		...
		EditorGUILayout.PropertyField(serializedObject.FindProperty("onEnterParents"), new GUIContent("Destroy These Parents Children", "These parent GameObject(s) will have all their children destroyed."), true);
		// Decrease the Indent.
		EditorGUI.indentLevel--;
		...
		EditorGUILayout.PropertyField(serializedObject.FindProperty("onExitParents"), new GUIContent("Destroy These Parents Children", "These parent GameObject(s) will have all their children destroyed."), true);
		// Decrease the Indent.
		EditorGUI.indentLevel--;
		// End the Toggle Group.
		EditorGUILayout.EndToggleGroup();
